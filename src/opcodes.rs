...
lazy_static! {
    pub static ref OPSCODES_MAP: HashMap<u8, OpCode> = {
        ...
        codes.insert(0x08, OpCode::new("PHP", 1, 3, AddressingMode::NoneAddressing));
        codes.insert(0x09, OpCode::new("ORA", 2, 2, AddressingMode::Immediate));
        codes.insert(0x0a, OpCode::new("ASL", 1, 2, AddressingMode::NoneAddressing));
        ...
        codes.insert(0x18, OpCode::new("CLC", 1, 2, AddressingMode::NoneAddressing));
        ...
        codes.insert(0x28, OpCode::new("PLP", 1, 4, AddressingMode::NoneAddressing));
        codes.insert(0x29, OpCode::new("AND", 2, 2, AddressingMode::Immediate));
        codes.insert(0x2a, OpCode::new("ROL", 1, 2, AddressingMode::NoneAddressing));
        ...
        codes.insert(0x38, OpCode::new("SEC", 1, 2, AddressingMode::NoneAddressing));
        ...
        codes.insert(0x40, OpCode::new("RTI", 1, 6, AddressingMode::NoneAddressing));
        ...
        codes.insert(0x48, OpCode::new("PHA", 1, 3, AddressingMode::NoneAddressing));
        codes.insert(0x49, OpCode::new("EOR", 2, 2, AddressingMode::Immediate));
        codes.insert(0x4a, OpCode::new("LSR", 1, 2, AddressingMode::NoneAddressing));
        ...
        codes.insert(0x58, OpCode::new("CLI", 1, 2, AddressingMode::NoneAddressing));
        ...
        codes.insert(0x60, OpCode::new("RTS", 1, 6, AddressingMode::NoneAddressing));
        ...
        codes.insert(0x68, OpCode::new("PLA", 1, 4, AddressingMode::NoneAddressing));
        codes.insert(0x69, OpCode::new("ADC", 2, 2, AddressingMode::Immediate));
        codes.insert(0x6a, OpCode::new("ROR", 1, 2, AddressingMode::NoneAddressing));
        ...
        codes.insert(0x78, OpCode::new("SEI", 1, 2, AddressingMode::NoneAddressing));
        ...
        codes.insert(0x88, OpCode::new("DEY", 1, 2, AddressingMode::NoneAddressing));
        codes.insert(0x8a, OpCode::new("TXA", 1, 2, AddressingMode::NoneAddressing));
        ...
        codes.insert(0x98, OpCode::new("TYA", 1, 2, AddressingMode::NoneAddressing));
        codes.insert(0x99, OpCode::new("STA", 3, 5, AddressingMode::AbsoluteY));
        codes.insert(0x9a, OpCode::new("TXS", 1, 2, AddressingMode::NoneAddressing));
        ...
        codes.insert(0xa8, OpCode::new("TAY", 1, 2, AddressingMode::NoneAddressing));
        codes.insert(0xa9, OpCode::new("LDA", 2, 2, AddressingMode::Immediate));
        codes.insert(0xaa, OpCode::new("TAX", 1, 2, AddressingMode::NoneAddressing));
        ...
        codes.insert(0xb8, OpCode::new("CLV", 1, 2, AddressingMode::NoneAddressing));
        codes.insert(0xb9, OpCode::new("LDA", 3, 4, AddressingMode::AbsoluteY)); // extras 1
        codes.insert(0xba, OpCode::new("TSX", 1, 2, AddressingMode::NoneAddressing));
        ...
        codes.insert(0xc8, OpCode::new("INY", 1, 2, AddressingMode::NoneAddressing));
        codes.insert(0xc9, OpCode::new("CMP", 2, 2, AddressingMode::Immediate));
        codes.insert(0xca, OpCode::new("DEX", 1, 2, AddressingMode::NoneAddressing));
        ...
        codes.insert(0xd8, OpCode::new("CLD", 1, 2, AddressingMode::NoneAddressing));
        ...
        codes.insert(0xe8, OpCode::new("INX", 1, 2, AddressingMode::NoneAddressing));
        codes.insert(0xe9, OpCode::new("SBC", 2, 2, AddressingMode::Immediate));
        codes.insert(0xea, OpCode::new("NOP", 1, 2, AddressingMode::NoneAddressing));
        ...
        codes.insert(0xf8, OpCode::new("SED", 1, 2, AddressingMode::NoneAddressing));
